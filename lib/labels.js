...
export const DEFAULT_LABELS = {
  ...
  nav_executive_summary: 'الملخص التنفيذي',
  excel_export_btn: 'تصدير Excel',
  exec_summary_title: 'الملخص التنفيذي',
  exec_summary_subtitle: 'نظرة سريعة على أداء العمل',
  exec_kpi_income: 'الإيرادات',
  exec_kpi_expenses: 'المصروفات',
  exec_kpi_net: 'صافي الدخل',
  exec_vs_last_month: 'مقارنة بالشهر الماضي',
  exec_vs_last_year: 'مقارنة بنفس الشهر العام الماضي',
  exec_trend_chart_title: 'اتجاه الإيرادات خلال 12 شهر',
  exec_top_branches_title: 'أفضل 3 فروع (صافي الدخل)',
  exec_bottom_branches_title: 'أقل 3 فروع (صافي الدخل)',
  exec_ranking_title: 'ترتيب الفروع',
  exec_sort_net: 'صافي الدخل',
  exec_sort_expense_ratio: 'نسبة المصروفات',
  exec_sort_growth: 'نسبة النمو',
  exec_ranking_col_branch: 'الفرع',
  exec_ranking_col_value: 'القيمة',
...
export const LABEL_GROUPS = [
  ...
  {
    title: 'الملخص التنفيذي / Executive summary',
    keys: [
      'nav_executive_summary', 'excel_export_btn', 'exec_summary_title', 'exec_summary_subtitle',
      'exec_kpi_income', 'exec_kpi_expenses', 'exec_kpi_net',
      'exec_vs_last_month', 'exec_vs_last_year', 'exec_trend_chart_title',
      'exec_top_branches_title', 'exec_bottom_branches_title', 'exec_ranking_title',
      'exec_sort_net', 'exec_sort_expense_ratio', 'exec_sort_growth',
      'exec_ranking_col_branch', 'exec_ranking_col_value',
    ],
  },
  {
